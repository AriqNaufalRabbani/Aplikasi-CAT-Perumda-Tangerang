...
<head>
	...
	<title>Login – Kuesioner CAT COPD</title>
	...
	<!-- Theme style -->
	<link rel="stylesheet" href="<?= BASE_URL; ?>cdn/css/login/style.css">
...
<body class="login-page">
	...
	<div class="left">
		...
		<!-- <div class="stats">
			<div class="stat">
				...
				<div class="stat-l">Pertanyaan</div>
			</div>
			<div class="stat">
				<div class="stat-n">0–40</div>
				<div class="stat-l">Rentang Skor</div>
			</div>
			<div class="stat">
				<div class="stat-n">±3 min</div>
				<div class="stat-l">Waktu Isi</div>
			</div>
		</div> -->
	...
	<div class="right">
		<div class="form-box">
			<form action="login/process" method="post" id="form_login" autocomplete="false" >

				<div class="tagline">Selamat Datang</div>
				<h1 class="form-title">Masuk ke<br />Portal Aplikasi CAT</h1>
				<p class="form-desc">
	...
	<script>
		// if ('service deWorker' in navigator) {
