!(function (e, t) {
  ...
  try {
    (function () {
      lt =
        lt && Object.prototype.hasOwnProperty.call(lt, "default")
          ? lt.default
          : lt;
      var n = function (e, t) {
        return (n =
      ...
      var K,
        ...
        B = 36e5,
        R =
          (((K = {})["missing-app-config-values"] =
            'Missing App configuration value: "{$valueName}"'),
          (K["not-registered"] = "Firebase Installation is not registered."),
          (K["installation-not-found"] = "Firebase Installation not found."),
          (K["request-failed"] =
            '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"'),
          (K["app-offline"] =
            "Could not process request. Application offline."),
          (K["delete-pending-registration"] =
            "Can't delete installation while there is a pending registration request."),
          K),
        L = new u("installations", "Installations", R);
      function V(e) {
      ...
      function $(e, t) {
        var n = t.refreshToken,
          r = U(e);
        return r.append("Authorization", A + " " + n), r;
      }
      function G(n) {
        return v(this, void 0, void 0, function () {
          var t;
      ...
      function Z() {
        try {
          ...
          (self.crypto || self.msCrypto).getRandomValues(e),
            (e[0] = 112 + (e[0] % 16));
          var t = (function (e) {
            return btoa(String.fromCharCode.apply(String, i(e)))
              .replace(/\+/g, "-")
              .replace(/\//g, "_");
          })(e).substr(0, 22);
          return J.test(t) ? t : Y;
      ...
      function re() {
        return (
          !ne &&
            ...
            ((ne = new BroadcastChannel("[Firebase] FID Change")).onmessage =
              function (e) {
        ...
        return v(this, void 0, void 0, function () {
          ...
          return g(this, function (e) {
            switch (e.label) {
              ...
              case 7:
                return (
                  e.sent(), !s || (o && o.fid === s.fid) || ee(a, s.fid), [2, s]
                );
            }
          });
        });
            ...
            switch (e.label) {
              case 0:
                return [
                  4,
                  he(i, function (e) {
                    var t = be(e || { fid: Z(), registrationStatus: 0 }),
                      n = (function (e, t) {
                        {
        ...
        return v(this, void 0, void 0, function () {
          ...
          return g(this, function (e) {
            switch (e.label) {
              ...
              case 2:
                return (c = e.sent()), [2, F(c)];
              case 3:
                return [4, H("Generate Auth Token", u)];
              case 4:
                throw e.sent();
            }
            var t, n;
                    ...
                    he(a.appConfig, function (e) {
                      ...
                      if (
                        ...
                        (function (e) {
                          ...
                          return (
                            t < e.creationTime ||
                            e.creationTime + e.expiresIn < t + B
                          );
                        })(r)
                      ) {
      ...
      function me(e) {
        return he(e, function (e) {
          ...
          var t,
            n = e.authToken;
          return 1 === (t = n).requestStatus && t.requestTime + N < Date.now()
            ? h(h({}, e), { authToken: { requestStatus: 0 } })
            : e;
        });
      }
      function ke(e) {
        ...
        return (
          ...
          function () {
            ...
            (e = r),
              (t = Q(i)),
              (n = X.get(t)) &&
                (n.delete(e), 0 === n.size && X.delete(t), ie());
          }
        );
      }
      function Te(e) {
      ...
      (oe = lt).INTERNAL.registerComponent(
        new f(
          "installations",
          function (e) {
        ...
        oe.registerVersion("@firebase/installations", O);
      var _e =
          (((se = {})["missing-app-config-values"] =
            'Missing App configuration value: "{$valueName}"'),
          (se["only-available-in-window"] =
            "This method is available in a Window context."),
          (se["only-available-in-sw"] =
            "This method is available in a service worker context."),
          (se["permission-default"] =
            "The notification permission was not granted and dismissed instead."),
          (se["permission-blocked"] =
            "The notification permission was not granted and blocked instead."),
          (se["unsupported-browser"] =
            "This browser doesn't support the API's required to use the firebase SDK."),
          (se["failed-service-worker-registration"] =
            "We are unable to register the default service worker. {$browserErrorMessage}"),
          (se["token-subscribe-failed"] =
            "A problem occured while subscribing the user to FCM: {$errorInfo}"),
          (se["token-subscribe-no-token"] =
            "FCM returned no token when subscribing the user to push."),
          (se["token-unsubscribe-failed"] =
            "A problem occured while unsubscribing the user from FCM: {$errorInfo}"),
          (se["token-update-failed"] =
            "A problem occured while updating the user from FCM: {$errorInfo}"),
          (se["token-update-no-token"] =
            "FCM returned no token when updating the user to push."),
          (se["use-sw-after-get-token"] =
            "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used."),
          (se["invalid-sw-registration"] =
            "The input to useServiceWorker() must be a ServiceWorkerRegistration."),
          (se["invalid-bg-handler"] =
            "The input to setBackgroundMessageHandler() must be a function."),
          (se["invalid-vapid-key"] = "The public VAPID key must be a string."),
          (se["use-vapid-key-after-get-token"] =
            "The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."),
          se),
        Pe = new u("messaging", "Messaging", _e);
      function je(e) {
        return Pe.create("missing-app-config-values", { valueName: e });
      }
      function Ee(e) {
        var t = new Uint8Array(e);
        return btoa(String.fromCharCode.apply(String, i(t)))
          .replace(/=/g, "")
          .replace(/\+/g, "-")
          .replace(/\//g, "_");
      }
                    ...
                    D(De, xe, function (o) {
                      return v(n, void 0, void 0, function () {
                        ...
                        return g(this, function (e) {
                          switch (e.label) {
                            case 0:
                              return o.oldVersion < 2
                                ? [2]
                                : o.objectStoreNames.contains(Ke)
                                ? [
                                    4,
                                    (t = o.transaction.objectStore(Ke))
                                      .index("fcmSenderId")
                                      .get(a),
                                  ]
                                : [2];
                            ...
                            case 2:
                              ...
                              if (2 === o.oldVersion) {
                                if (!(r = n).auth || !r.p256dh || !r.endpoint)
                                  return [2];
                                s = {
                                  token: r.fcmToken,
                                  createTime:
                                    null !== (i = r.createTime) && void 0 !== i
                                      ? i
                                      : Date.now(),
                                  subscriptionOptions: {
                                    auth: r.auth,
                              ...
                              } else (3 === o.oldVersion || 4 === o.oldVersion) && (s = { token: (r = n).fcmToken, createTime: r.createTime, subscriptionOptions: { auth: Ee(r.auth), p256dh: Ee(r.p256dh), endpoint: r.endpoint, swScope: r.swScope, vapidKey: Ee(r.vapidKey) } });
                              return [2];
                          }
                        });
                      });
              ...
              case 6:
                return (
                  ...
                  [
                    2,
                    (function (e) {
                      if (!e || !e.subscriptionOptions) return;
            ...
            switch (e.label) {
              ...
              case 4:
                if ((r = e.sent()).error)
                  throw (
                    ((i = r.error.message),
                    Pe.create("token-unsubscribe-failed", { errorInfo: i }))
                  );
                return [3, 6];
              case 5:
                throw (
                  ((o = e.sent()),
                  Pe.create("token-unsubscribe-failed", { errorInfo: o }))
                );
              case 6:
                return [2];
            }
            ...
            switch (e.label) {
              case 0:
                if ("granted" !== Notification.permission)
                  throw Pe.create("permission-blocked");
                return [
                  4,
                  (function (n, r) {
                    return v(this, void 0, void 0, function () {
              ...
              case 3:
                ...
                e.label = 4;
              case 4:
                return e.trys.push([4, 6, , 7]), [4, $e(f, u.token)];
              case 5:
                return e.sent(), [3, 7];
              case 6:
                return (l = e.sent()), console.warn(l), [3, 7];
              case 7:
                return [2, et(f, c)];
              case 8:
                return Date.now() >= u.createTime + 6048e5
                  ? [
                      2,
                      (function (i, o, s) {
                        return v(this, void 0, void 0, function () {
                      ...
                      return g(this, function (e) {
                        switch (e.label) {
                          ...
                          case 5:
                            throw (
                              ((o = e.sent()),
                              Pe.create("token-subscribe-failed", {
                                errorInfo: o,
                              }))
                            );
                          case 6:
      ...
      ((Ze = Ye = Ye || {}).PUSH_RECEIVED = "push-received"),
        (Ze.NOTIFICATION_CLICKED = "notification-clicked");
      var nt =
          ...
          return v(this, void 0, void 0, function () {
            ...
            return g(this, function (e) {
              switch (e.label) {
                case 0:
                  return (
                    this.vapidKey || (this.vapidKey = We),
                    [4, this.getServiceWorkerRegistration()]
                  );
                case 1:
                  return (
                    (t = e.sent()),
            ...
            return g(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  ...
                  throw "denied" === t
                    ? Pe.create("permission-blocked")
                    : Pe.create("permission-default");
              }
            });
          });
        }),
        (rt.prototype.usePublicVapidKey = function (e) {
          if (null !== this.vapidKey)
            throw Pe.create("use-vapid-key-after-get-token");
          if ("string" != typeof e || 0 === e.length)
            throw Pe.create("invalid-vapid-key");
          this.vapidKey = e;
        }),
        (rt.prototype.useServiceWorker = function (e) {
          if (!(e instanceof ServiceWorkerRegistration))
            throw Pe.create("invalid-sw-registration");
            ...
            return g(this, function (e) {
              switch (e.label) {
                ...
                case 3:
                  throw (
                    ((n = e.sent()),
                    Pe.create("failed-service-worker-registration", {
      ...
      var it =
        ...
        (ot.prototype.setBackgroundMessageHandler = function (e) {
          if (!e || "function" != typeof e)
            throw Pe.create("invalid-bg-handler");
              ...
              switch (e.label) {
                case 0:
                  return this.vapidKey
                    ? [3, 2]
                    : [4, Re(this.firebaseDependencies)];
                case 1:
                  (t = e.sent()),
                    (this.vapidKey =
                      null !==
              ...
              switch (e.label) {
                case 0:
                  return (t = (function (e) {
                    ...
                    : [2];
                case 1:
                  return (n = e.sent()).some(function (e) {
                    return (
                    ...
                    : (r = (function (e) {
                        ...
                        if (e && "object" == typeof e.notification) {
                          var n = h({}, e.notification);
                          return (
                            (n.data = h(
                              h({}, e.notification.data),
                              (((t = {})[He] = e), t)
                            )),
                            n
                          );
              ...
              switch (e.label) {
                case 0:
                  return n.newSubscription
                    ? [3, 2]
                    : [4, Xe(this.firebaseDependencies, self.registration)];
                case 1:
                  return e.sent(), [2];
                case 2:
        ...
        (ot.prototype.onNotificationClick = function (s) {
          var a, u;
          return v(this, void 0, void 0, function () {
            var n, r, i, o;
            return g(this, function (e) {
              switch (e.label) {
                              ...
                              return v(this, void 0, void 0, function () {
                                ...
                                return g(this, function (e) {
                                  switch (e.label) {
                                    case 0:
                                      return (
                                        (t = new URL(u, self.location.href)),
                                        [4, st()]
                                      );
                                    case 1:
                                      n = e.sent();
                                      try {
                                        for (
                                          ...
                                          if (
                                            ((o = i.value),
                                            new URL(o.url, self.location.href)
                                              .host === t.host)
                                          )
                                            return [2, o];
                                      } catch (e) {
                ...
                case 6:
                  return i
                    ? ((o = at(Ye.NOTIFICATION_CLICKED, n)),
                      [2, i.postMessage(o)])
                    : [2];
              }
              var t;
      ...
      lt.INTERNAL.registerComponent(
        new f(
          ...
          function (e) {
            ...
            return new (self && "ServiceWorkerGlobalScope" in self ? it : nt)(
              n
            );
          },
          "PUBLIC"
