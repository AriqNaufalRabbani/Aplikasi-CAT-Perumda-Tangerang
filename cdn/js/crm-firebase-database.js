...
function g(e, t) {
  ...
  for (const n in t)
    t.hasOwnProperty(n) && "__proto__" !== n && (e[n] = g(e[n], t[n]));
  return e;
}
const m = () =>
    (function () {
  ...
  v = (e) => {
    const t = ((e) => {
      var t, n;
      return null ===
        (n = null === (t = y()) || void 0 === t ? void 0 : t.emulatorHosts) ||
        void 0 === n
        ? void 0
        : n[e];
    })(e);
...
class H {
  ...
  set(e, t) {
    null == t
      ...
      : this.domStorage_.setItem(this.prefixedName_(e), E(t));
  }
  get(e) {
...
const ee = function (e, t) {
    a(!t || !0 === e || !1 === e, "Can't turn on custom loggers persistently."),
      !0 === e
        ? ((Q.logLevel = L.VERBOSE),
          (X = Q.log.bind(Q)),
          t && K.set("logging_enabled", !0))
        : "function" == typeof e
        ? (X = e)
        : ((X = null), K.remove("logging_enabled"));
  },
  te = function (...e) {
    if (
      (!0 === Z &&
        ((Z = !1), null === X && !0 === K.get("logging_enabled") && ee(!0)),
      X)
    ) {
...
class Ee {
  constructor(e, t, n, i, s = !1, r = "", o = !1, a = !1) {
    (this.secure = t),
      ...
      (this.internalHost = Y.get("host:" + e) || this._host);
  }
  isCacheableHost() {
  ...
  set host(e) {
    e !== this.internalHost &&
      ((this.internalHost = e),
      this.isCacheableHost() && Y.set("host:" + this._host, this.internalHost));
  }
  toString() {
  ...
  constructor(e, t, n, i) {
      ...
      (this.sendNewPolls = !0);
    {
      (this.uniqueCallbackIdentifier = $()),
        ...
        (this.myIFrame = De.createIFrame_());
      let n = "";
      if (
        this.myIFrame.src &&
...
class Oe {
  constructor(e, t, n, i, s, r, o) {
    (this.connId = e),
      ...
      (this.bytesSent = 0),
      (this.bytesReceived = 0),
      (this.log_ = ne(this.connId)),
      (this.stats_ = Pe(t)),
      (this.connURL = Oe.connectionURL_(t, r, o, i, n)),
  ...
  onHandshake_(e) {
    ...
    (this.sessionId = e.s),
      ...
      0 === this.state_ &&
        ...
        "5" !== n && re("Protocol version mismatch detected"),
...
class et {
  constructor(e, t) {
    ...
    for (let e = 0; e < this.parts_.length; e++)
      this.byteLength_ += D(this.parts_[e]);
    tt(this);
  }
}
function tt(e) {
...
class st extends Me {
  constructor(e, t, n, i, s, r, o, a) {
    if (
      ...
      (this.id = st.nextPersistentConnectionId_++),
      (this.log_ = ne("p:" + this.id + ":")),
    ...
    it.getInstance().on("visible", this.onVisible_, this),
      -1 === e.host.indexOf("fblocal") &&
        We.getInstance().on("online", this.onOnline_, this);
  }
  sendRequest(e, t, n) {
  ...
  async establishConnection_() {
    if (this.shouldReconnect_()) {
      ...
      const e = this.onDataMessage_.bind(this),
        ...
        i = this.id + ":" + st.nextConnectionId_++,
      ...
      try {
        ...
        this.log_("Failed to get token: " + e),
          r || (this.repoInfo_.nodeAdmin && re(e), l());
      }
    }
  }
  interrupt(e) {
    te("Interrupting connection for reason: " + e),
  ...
  resume(e) {
    te("Resuming connection for reason: " + e),
      delete this.interruptReasons_[e],
      N(this.interruptReasons_) &&
        ((this.reconnectDelay_ = 1e3),
        this.realtime_ || this.scheduleConnect_(0));
  }
  handleTimestamp_(e) {
  ...
  onAppCheckRevoked_(e, t) {
    te("App check token revoked: " + e + "/" + t),
      (this.appCheckToken_ = null),
      (this.forceTokenRefresh_ = !0),
      ("invalid_token" !== e && "permission_denied" !== e) ||
...
class ut {
  constructor(e, t, n, i, s) {
    (this.key = e),
      (this.value = t),
      (this.color = null != n ? n : ut.RED),
      (this.left = null != i ? i : dt.EMPTY_NODE),
      (this.right = null != s ? s : dt.EMPTY_NODE);
  }
  copy(e, t, n, i, s) {
    return new ut(
      null != e ? e : this.key,
...
class wt {
  ...
  getImmediateChild(e) {
    return ".priority" === e
      ? this.priorityNode_
      : wt.__childrenNodeConstructor.EMPTY_NODE;
  }
  getChild(e) {
    return $e(e)
      ? this
  ...
  updateImmediateChild(e, t) {
    return ".priority" === e
      ...
      ? this
      : wt.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(
          e,
          t
    ...
    return null === n
      ...
      : (a(
        ...
        this.updateImmediateChild(
          n,
          wt.__childrenNodeConstructor.EMPTY_NODE.updateChild(Ve(e), t)
        ));
  }
  isEmpty() {
    return !1;
  ...
  hash() {
    if (null === this.lazyHash_) {
      ...
      this.priorityNode_.isEmpty() ||
        (e += "priority:" + gt(this.priorityNode_.val()) + ":");
      const t = typeof this.value_;
      (e += t + ":"),
        (e += "number" === t ? fe(this.value_) : this.value_),
        (this.lazyHash_ = G(e));
    }
  ...
  compareTo(e) {
    return e === wt.__childrenNodeConstructor.EMPTY_NODE
      ? 1
      : e instanceof wt.__childrenNodeConstructor
      ? -1
  ...
  compareToLeafNode_(e) {
    const t = typeof e.value_,
      ...
      i = wt.VALUE_TYPE_ORDER.indexOf(t),
      s = wt.VALUE_TYPE_ORDER.indexOf(n);
    return (
...
wt.VALUE_TYPE_ORDER = ["object", "boolean", "number", "string"];
...
class Et {
  constructor(e) {
    var t;
    (this.count = ((t = e + 1), parseInt(Math.log(t) / bt, 10))),
  ...
  const s = function (t, i) {
      ...
      if (1 === r)
        return (
          (o = e[t]),
          (a = n ? n(o) : o),
          new ut(a, o.node, ut.BLACK, null, null)
        );
      {
        const l = parseInt(r / 2, 10) + t,
          ...
          c = s(l + 1, i);
        return (
          (o = e[l]), (a = n ? n(o) : o), new ut(a, o.node, ut.BLACK, h, c)
        );
      }
    },
    r = (function (t) {
...
class Nt {
  ...
  static get Default() {
    return (
      a(kt && Tt, "ChildrenNode.ts has not been loaded"),
      (St = St || new Nt({ ".priority": kt }, { ".priority": Tt })),
      St
    );
  }
  get(e) {
...
class xt {
  ...
  updatePriority(e) {
    return this.children_.isEmpty()
      ? this
      : new xt(this.children_, e, this.indexMap_);
  }
  getImmediateChild(e) {
  ...
  val(e) {
    ...
    let n = 0,
      ...
      s = !0;
    if (
      (this.forEachChild(Tt, (r, o) => {
        (t[r] = o.val(e)),
          n++,
          s && xt.INTEGER_REGEXP_.test(r)
  ...
  hash() {
    if (null === this.lazyHash_) {
      let e = "";
      this.getPriority().isEmpty() ||
        (e += "priority:" + gt(this.getPriority().val()) + ":"),
        this.forEachChild(Tt, (t, n) => {
          const i = n.hash();
          "" !== i && (e += ":" + t + ":" + i);
        }),
...
Object.defineProperties(rt, {
  MIN: { value: new rt(ae, xt.EMPTY_NODE) },
  MAX: { value: new rt(le, Rt) },
}),
  (lt.__EMPTY_NODE = xt.EMPTY_NODE),
  (wt.__childrenNodeConstructor = xt),
  (ft = Rt),
  (function (e) {
    Ct = e;
  })(Rt);
function Dt(e, t = null) {
  ...
  }
  {
    ...
    if (
      (pe(e, (e, t) => {
        if ("." !== e.substring(0, 1)) {
          const s = Dt(t);
          s.isEmpty() ||
            ((i = i || !s.getPriority().isEmpty()), n.push(new rt(e, s)));
        }
      }),
      0 === n.length)
    )
    ...
    if (i) {
      ...
      return new xt(s, Dt(t), new Nt({ ".priority": e }, { ".priority": Tt }));
    }
...
class At extends ot {
  ...
  makePost(e, t) {
    const n = Dt(e),
      i = xt.EMPTY_NODE.updateChild(this.indexPath_, n);
    return new rt(t, i);
  }
  maxPost() {
...
class Wt {
  ...
  updateChild(e, t, n, i, s, r) {
    ...
    return o.getChild(i).equals(n.getChild(i)) && o.isEmpty() === n.isEmpty()
      ...
      : (null != r &&
          (n.isEmpty()
            ? e.hasChild(t)
              ? r.trackChildChange(Mt(t, o))
              : a(
                  e.isLeafNode(),
                  "A child remove without an old child only makes sense on a leaf node"
                )
            : o.isEmpty()
            ? r.trackChildChange(Ft(t, n))
  ...
  updateFullNode(e, t, n) {
    return (
      null != n &&
        (e.isLeafNode() ||
          e.forEachChild(Tt, (e, i) => {
            t.hasChild(e) || n.trackChildChange(Mt(e, i));
          }),
        t.isLeafNode() ||
          t.forEachChild(Tt, (t, i) => {
            if (e.hasChild(t)) {
...
class Ut {
  ...
  updateChild(e, t, n, i, s, r) {
    return (
      this.matches(new rt(t, n)) || (n = xt.EMPTY_NODE),
  ...
  updateFullNode(e, t, n) {
    ...
    const s = this;
    return (
      t.forEachChild(Tt, (e, t) => {
        s.matches(new rt(e, t)) ||
          (i = i.updateImmediateChild(e, xt.EMPTY_NODE));
      }),
...
class Bt {
  ...
  updateChild(e, t, n, i, s, r) {
    return (
      this.rangedFilter_.matches(new rt(t, n)) || (n = xt.EMPTY_NODE),
  ...
  updateFullNode(e, t, n) {
    ...
    if (t.isLeafNode() || t.isEmpty()) i = xt.EMPTY_NODE.withIndex(this.index_);
      ...
      let e;
      (i = xt.EMPTY_NODE.withIndex(this.index_)),
        (e = this.reverse_
      ...
      for (; e.hasNext(); ) {
        ...
        this.withinDirectionalEnd(t)
          ? n++
          : (i = i.updateImmediateChild(t.name, xt.EMPTY_NODE));
      }
    }
  ...
  fullLimitUpdateChild_(e, t, n, i, s) {
    ...
    if (o.hasChild(t)) {
        ...
        );
      {
        ...
        return null != a && this.rangedFilter_.matches(a)
          ? (null != s && s.trackChildChange(Ft(a.name, a.node)),
    ...
    return n.isEmpty()
      ...
      : c && r(h, l) >= 0
      ? (null != s &&
          (s.trackChildChange(Mt(h.name, h.node)),
          s.trackChildChange(Ft(t, n))),
        o
          .updateImmediateChild(t, n)
          .updateImmediateChild(h.name, xt.EMPTY_NODE))
      : e;
  }
}
class jt {
  ...
  getIndexStartName() {
    return (
      a(this.startSet_, "Only valid if start has been set"),
      this.startNameSet_ ? this.indexStartName_ : ae
    );
  }
  hasEnd() {
    return this.endSet_;
  ...
  getIndexEndName() {
    return (
      ...
      this.endNameSet_ ? this.indexEndName_ : le
    );
  }
  hasLimit() {
...
function Yt(e) {
  ...
  if (
    (e.index_ === Tt
      ...
      : e.index_ === ht
      ? (n = "$key")
      : (a(e.index_ instanceof At, "Unrecognized index type!"),
        (n = e.index_.toString())),
    (t.orderBy = E(n)),
    e.startSet_)
  ) {
    const n = e.startAfterSet_ ? "startAfter" : "startAt";
    (t[n] = E(e.indexStartValue_)),
      e.startNameSet_ && (t[n] += "," + E(e.indexStartName_));
  }
  if (e.endSet_) {
    const n = e.endBeforeSet_ ? "endBefore" : "endAt";
    (t[n] = E(e.indexEndValue_)),
      e.endNameSet_ && (t[n] += "," + E(e.indexEndName_));
  }
  return (
    e.limitSet_ &&
      (e.isViewFromLeft()
...
class tn {
  ...
  reportStats_() {
    ...
    pe(e, (e, i) => {
      ...
      ve(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5));
  }
}
var nn;
function sn(e) {
...
class rn {
  ...
  operationForChild(e) {
    ...
    return (
      a(je(this.path) === e, "operationForChild called for unrelated child."),
      new rn(Ve(this.path), this.affectedTree, this.revert)
    );
  }
}
class on {
  ...
  operationForChild(e) {
    return $e(this.path)
      ? new on(this.source, Be())
      : new on(this.source, Ve(this.path));
  }
}
class an {
  constructor(e, t, n) {
  ...
  operationForChild(e) {
    return $e(this.path)
      ? new an(this.source, Be(), this.snap.getImmediateChild(e))
      : new an(this.source, Ve(this.path), this.snap);
  }
}
class ln {
  constructor(e, t, n) {
  ...
  operationForChild(e) {
    if ($e(this.path)) {
      ...
      return t.isEmpty()
        ? null
        : t.value
        ? new an(this.source, Be(), t.value)
        : new ln(this.source, Be(), t);
    }
    return (
      a(
        je(this.path) === e,
      ...
      new ln(this.source, Ve(this.path), this.children)
    );
  }
  toString() {
    return (
  ...
  o.sort((t, n) =>
    (function (e, t, n) {
      ...
      const i = new rt(t.childName, t.snapshotNode),
        s = new rt(n.childName, n.snapshotNode);
...
class yn {
  ...
  findRootMostMatchingPathAndValue(e, t) {
    if (null != this.value && t(this.value))
      return { path: Be(), value: this.value };
    if ($e(e)) return null;
    {
      const n = je(e),
      ...
      if (null !== i) {
        ...
        if (null != s) {
          return { path: Qe(new Ue(n), s.path), value: s.value };
        }
        return null;
      }
      return null;
  ...
  set(e, t) {
    ...
    {
      const n = je(e),
        i = (this.children.get(n) || new yn(null)).set(Ve(e), t),
  ...
  setTree(e, t) {
    ...
    {
      const n = je(e),
        i = (this.children.get(n) || new yn(null)).setTree(Ve(e), t);
      let s;
      return (
        (s = i.isEmpty()
  ...
  if (null != t.value) return n.updateChild(e, t.value);
  {
    ...
    return (
      ...
      n.getChild(e).isEmpty() ||
        null === i ||
        (n = n.updateChild(Qe(e, ".priority"), i)),
      n
    );
  }
}
...
function Rn(e, t) {
  ...
  for (; s && o >= 0; ) {
    ...
    t.visible &&
      (o >= n && Dn(t, i.path) ? (s = !1) : Ze(i.path, t.path) && (r = !0)),
      o--;
  }
  if (s) {
    if (r)
      return (
        (function (e) {
          (e.visibleWrites = On(e.allWrites, An, Be())),
...
function Dn(e, t) {
  ...
  for (const n in e.children)
    if (e.children.hasOwnProperty(n) && Ze(Qe(e.path, n), t)) return !0;
  return !1;
}
function An(e) {
  return e.visible;
...
function On(e, t, n) {
  ...
  for (let s = 0; s < e.length; ++s) {
    ...
    if (t(r)) {
      ...
      if (r.snap)
        Ze(n, e)
          ? ((t = Ge(n, e)), (i = Cn(i, t, r.snap)))
          : Ze(e, n) && ((t = Ge(e, n)), (i = Cn(i, Be(), r.snap.getChild(t))));
      else {
  ...
  trackChildChange(e) {
    ...
    if (i) {
      ...
      if ("child_added" === t && "child_removed" === s)
        ...
        this.changeMap.set(n, Mt(n, i.oldSnap));
      else if ("child_changed" === t && "child_added" === s)
        this.changeMap.set(n, Ft(n, e.snapshotNode));
      else {
  ...
  if (n.type === nn.OVERWRITE) {
    ...
    l.source.fromUser
      ...
      : (a(l.source.fromServer, "Unknown source."),
        (h = l.source.tagged || (t.serverCache.isFiltered() && !$e(l.path))),
    ...
    o = l.revert
          ...
          if (null != Wn(i, n)) return t;
          {
            ...
            if ($e(n) || ".priority" === je(n)) {
              ...
              null == a &&
                ...
                (c =
                  null != a
                    ? e.filter.updateChild(h, s, a, Ve(n), l, r)
                    : t.eventCache.getNode().hasChild(s)
                    ? e.filter.updateChild(h, s, xt.EMPTY_NODE, Ve(n), l, r)
                    : h),
                c.isEmpty() &&
            ...
            return (
              (o = t.serverCache.isFullyInitialized() || null != Wn(i, Be())),
      ...
      : (function (e, t, n, i, s, r, o) {
          ...
          const a = t.serverCache.isFiltered(),
            l = t.serverCache;
          if (null != i.value) {
            if (($e(n) && l.isFullyInitialized()) || l.isCompleteForPath(n))
              return $n(e, t, n, l.getNode().getChild(n), s, r, a, o);
            if ($e(n)) {
              let i = new yn(null);
              return (
                l.getNode().forEachChild(ht, (e, t) => {
                  i = i.set(new Ue(e), t);
                }),
                Zn(e, t, n, i, s, r, a, o)
              );
    ...
    o = (function (e, t, n, i, s) {
      const r = t.serverCache,
        o = pn(t, r.getNode(), r.isFullyInitialized() || $e(n), r.isFiltered());
  ...
  if (null != Wn(i, n)) return t;
  {
    ...
    if ($e(n))
      if (
        ...
        const n = gn(t),
          s = Mn(i, n instanceof xt ? n : xt.EMPTY_NODE);
  ...
  if ($e(n))
    ...
    if (".priority" === s)
      ...
      if ($e(r)) u = i;
        ...
        u =
          null != e
            ? ".priority" === ze(r) && e.getChild(Ke(r)).isEmpty()
              ? e
              : e.updateChild(r, i)
            : xt.EMPTY_NODE;
      }
...
class ei {
  constructor(e, t) {
    ...
    const o = t.serverCache,
      a = t.eventCache,
      l = i.updateFullNode(xt.EMPTY_NODE, o.getNode(), null),
      h = s.updateFullNode(xt.EMPTY_NODE, a.getNode(), null),
...
function ti(e, t) {
  ...
  return n &&
    (e.query._queryParams.loadsAllData() ||
      (!$e(t) && !n.getImmediateChild(je(t)).isEmpty()))
    ? n.getChild(t)
    : null;
}
function ni(e) {
      ...
      (function (e, t, n) {
        ...
        if (s)
          ...
          const t = l.fold((e, t, n) => {
            if (!$e(e) && t && mi(t)) return [yi(t).query];
            {
              let e = [];
              return (
...
function Mi(e) {
  ...
  return (
    ...
    { queryId: e.substr(t + 1), path: new Ue(e.substr(0, t)) }
  );
}
function qi(e, t, n) {
...
function Ki(e, t, n) {
  ...
  }
  {
    ...
    return (
      (r = i),
      s !== i.getPriority().val() && (r = r.updatePriority(new wt(s))),
      i.forEachChild(Tt, (e, i) => {
...
function $i(e, t) {
  let n = t instanceof Ue ? t : new Ue(t),
    i = e,
    s = je(n);
  for (; null !== s; ) {
    const e = k(i.node.children, s) || { children: {}, childCount: 0 };
...
const is = /[\[\].#$\/\u0000-\u001F\u007F]/,
  ...
  hs = function (e, t, n) {
    ...
    if ("function" == typeof t)
      throw new Error(
        e + "contains a function " + nt(i) + " with contents = " + t.toString()
      );
    if (oe(t)) throw new Error(e + "contains " + t.toString() + " " + nt(i));
    if ("string" == typeof t && t.length > 10485760 / 3 && D(t) > 10485760)
      throw new Error(
        e +
  ...
  cs = function (e, t, n, i) {
    ...
    pe(t, (e, t) => {
      const i = new Ue(e);
      if ((hs(s, t, Qe(n, i)), ".priority" === ze(i) && !as(t)))
        throw new Error(
          s +
...
function ms(e, t) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i],
      r = s.getPath();
    null === n || Xe(r, n.path) || (e.eventLists_.push(n), (n = null)),
...
function bs(e, t, n) {
  if (
    ...
    (e.persistentConnection_ = new st(
      e.repoInfo_,
      t,
      (t, n, i, s) => {
        Ss(e, t, n, i, s);
    ...
    !1 === t &&
      (function (e) {
        ...
        Zt(n, Be(), (t, n) => {
          ...
          (e.onDisconnect_ = Gt()),
          vs(e.eventQueue_, Be(), i);
      })(e);
}
function Ns(e, t, n) {
  const i = new Ue("/.info/" + t),
    s = Dt(n);
        ...
        if (
          ...
          if (h.retryCount >= 25)
            ...
            if (void 0 !== i) {
              ...
              let t = Dt(i);
              ("object" == typeof i && null != i && S(i, ".priority")) ||
...
const Ys = function (e, t) {
      ...
      const d = (function (e) {
        ...
        for (const n of e.split("&")) {
          ...
          2 === i.length
            ...
            : re(`Invalid query segment '${n}' in query '${e}'`);
        }
        return t;
  ...
  Qs = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",
  $s = (function () {
    let e = 0;
    const t = [];
    return function (n) {
      ...
      const r = new Array(8);
      for (s = 7; s >= 0; s--)
        (r[s] = Qs.charAt(n % 64)), (n = Math.floor(n / 64));
...
function nr(e) {
  ...
  if (
    ...
    (a(
      e.getIndex() instanceof At || e.getIndex() === Ot,
      "unknown index type."
    ),
...
function or(e, t) {
  return (
    (e = A(e))._checkNotDeleted("ref"), void 0 !== t ? lr(e._root, t) : e._root
  );
}
function ar(e, t) {
...
function cr(e, t) {
  ...
  let o;
  return (
    (o = null != t ? dr(r, t).then(() => r) : Promise.resolve(r)),
  ...
  return (
    (function (e, t, n, i) {
      ...
      if (
        ...
        te("update() called with empty data.  Don't do anything."),
          Fs(0, i, "ok", void 0);
      else {
        const s = Ps(e),
  ...
  return (function (e, t, n) {
    ...
    return null != i
      ...
      : e.server_.get(t).then(
          ...
          (n) => (
            Ls(e, "get for query " + E(t) + " failed: " + n),
            Promise.reject(new Error(n))
          )
        );
  })(e._repo, e, n).then(
    (t) => new rr(t, new sr(e._repo, e._path), e._queryParams.getIndex())
  );
}
class mr {
  constructor(e) {
  ...
  createEvent(e, t) {
    ...
    return new Gs(
      "value",
      this,
      new rr(e.snapshotNode, new sr(t._repo, t._path), n)
    );
  }
  getEventRunner(e) {
...
class yr {
  ...
  createEvent(e, t) {
    ...
    const n = lr(new sr(t._repo, t._path), e.childName),
...
function vr(e, t, n, i, s) {
  ...
  const o = new Xs(n, r || void 0),
    a = "value" === t ? new mr(o) : new yr(t, o);
  return (
    (function (e, t, n) {
      let i;
      (i =
...
class kr extends Sr {
  ...
  _apply(e) {
    ...
    if ((ir(t), nr(t), e._queryParams.hasEnd()))
      throw new Error(
...
class Pr extends Sr {
  ...
  _apply(e) {
    ...
    const t = (function (e, t, n) {
      let i;
      return (
        (i = e.index_ === ht || n ? Vt(e, t, n) : Vt(e, t, ae)),
        (i.endBeforeSet_ = !0),
        i
      );
...
class Rr extends Sr {
  ...
  _apply(e) {
    ...
    if ((ir(t), nr(t), e._queryParams.hasStart()))
      throw new Error(
...
class Ar extends Sr {
  ...
  _apply(e) {
    ...
    const t = (function (e, t, n) {
      let i;
      return (
        (i = e.index_ === ht || n ? Ht(e, t, n) : Ht(e, t, le)),
        (i.startAfterSet_ = !0),
        i
      );
    })(e._queryParams, this._value, this._key);
...
class Kr extends Sr {
  ...
  _apply(e) {
    ...
    return new kr(this._value, this._key)._apply(
      new Rr(this._value, this._key)._apply(e)
    );
  }
}
function Qr(e, t) {
...
function Xr(e, t, n, i, s) {
  ...
  void 0 === r &&
    ...
    te("Using default host for project ", e.options.projectId),
...
class Zr {
  ...
  get _root() {
    return (
      this._rootInternal || (this._rootInternal = new sr(this._repo, Be())),
      this._rootInternal
    );
  }
  _delete() {
    return (
      null !== this._rootInternal &&
        (!(function (e, t) {
          const n = Gr[t];
          (n && n[e.key] === e) ||
            se(`Database ${t}(${e.repoInfo_}) has already been deleted.`),
            Os(e),
            delete n[e.key];
  ...
  _checkNotDeleted(e) {
    null === this._rootInternal &&
      se("Cannot call " + e + " on a deleted database.");
  }
}
function eo() {
...
function so(e, t, n, i = {}) {
  (e = A(e))._checkNotDeleted("useEmulator"),
    e._instanceStarted &&
      se(
    ...
    const t =
      "string" == typeof i.mockUserToken
        ...
        : (function (e, t) {
            ...
            return [
              _(JSON.stringify({ alg: "none", type: "JWT" })),
              _(JSON.stringify(r)),
              "",
            ].join(".");
...
function oo(e) {
  var t;
  (e = A(e))._checkNotDeleted("goOnline"),
  ...
  return (
    (function (e, t, n, i, s, r) {
      ...
      (t, n, i) => {
        ...
        t
          ? r.reject(t)
          : ((s = new rr(i, new sr(e._repo, e._path), Tt)),
            r.resolve(new uo(n, s)));
      },
      o,
      s
    ),
...
const po = function (e) {
    ...
    return (
      (st.prototype.put = function (n, i, s, r) {
...
export {
  ...
  uo as TransactionResult,
  er as _QueryImpl,
  jt as _QueryParams,
  sr as _ReferenceImpl,
  fo as _TEST_ACCESS_forceRestClient,
  po as _TEST_ACCESS_hijackHash,
  Xr as _repoManagerDatabaseFromApp,
  j as _setSDKVersion,
  ...
  xr as endBefore,
  Qr as equalTo,
  no as forceLongPolling,
  to as forceWebSockets,
  gr as get,
  io as getDatabase,
  ro as goOffline,
  oo as goOnline,
  ...
  Ir as off,
  wr as onChildAdded,
  Tr as onChildChanged,
  br as onChildMoved,
  Er as onChildRemoved,
  hr as onDisconnect,
  Cr as onValue,
  Ur as orderByChild,
  jr as orderByKey,
  Vr as orderByPriority,
  Yr as orderByValue,
  cr as push,
  $r as query,
  or as ref,
  ar as refFromURL,
  ur as remove,
  _o as runTransaction,
  ho as serverTimestamp,
  dr as set,
  _r as setPriority,
  pr as setWithPriority,
  Or as startAfter,
  Dr as startAt,
  fr as update,
};
