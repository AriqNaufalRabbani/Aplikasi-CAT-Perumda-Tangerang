    ...
    b.extend(s.prototype, {
      ...
      update: function (t) {
        ...
        this.s.enable &&
          ...
          b(e).is(":visible") ? this.enable(!0, !1) : this.enable(!1, !1),
            ...
            (b(H)
              ...
              .on(
                ...
                n.util.throttle(function () {
                  (o.s.position.windowHeight = b(H).height()), o.update();
                }, 50)
              ),
            b(".fh-fixedHeader")),
          t =
            ...
            : ((e = b(x).scrollLeft()),
              ...
              a.floatingParent
                .css({
                  ...
                  height: "fit-content",
                  position: "fixed",
                  left: n ? i.offset().left + s.scrollLeft() : 0,
                })
                .css(
                  "header" === t
              ...
              (d = function () {
                ...
                (r.s.scrollLeft = { footer: t, header: t }),
                  a.floatingParent.scrollLeft(r.s.scrollLeft.header);
              })(),
      ...
      _stickyPosition: function (t, i) {
        var s, n;
        this._scrollEnabled() &&
          ((n = "rtl" === b((s = this).s.dt.table().node()).css("direction")),
      ...
      _unsize: function (t) {
        ...
        e && ("footer" === t || ("header" === t && !this.s.autoWidth))
          ...
          : e && "header" === t && b("th, td", e).css("min-width", "");
      },
      ...
      _modeChange: function (t, e, o) {
        ...
        ("footer" === e && c) ||
          ...
          (s = b.contains(r[0], x.activeElement) ? x.activeElement : null),
          ...
          "in-place" === t
            ? (h.placeholder &&
              ...
              b(b(h.host.parent()).parent()).scrollLeft(d.scrollLeft()))
            : "in" === t
            ? (this._clone(e, o),
              (r = d.offset()),
      ...
      _scroll: function (t) {
        ...
        this.s.dt.settings()[0].bDestroying ||
          ...
          this.s.dt.settings()[0]._fixedColumns !== v &&
            ((this.dom.header.rightBlocker = (m = function (t, e, o) {
              var i;
              return (
                null !==
                  (o =
