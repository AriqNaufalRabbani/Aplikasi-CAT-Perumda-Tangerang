...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            ...
            warnAfter: 604200000 , // 15 minutes
            // redirAfter: 1200000, // 20 minutes
            redirAfter: 604800000 , // 1 minggu
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-footer"> \
                    ...
                    <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-success" data-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
        ...
        if (!opt.ignoreUserActivity) {
            ...
            $(document).on('keyup mouseup mousemove touchend touchmove', function(e) {
                ...
                // RESET SESSION JIKA MOUSE DIGERAK KAN
