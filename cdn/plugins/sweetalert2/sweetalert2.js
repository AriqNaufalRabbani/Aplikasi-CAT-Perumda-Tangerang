!(function (e, t) {
  ...
  const v = () => W(".".concat(m.loader)),
    ...
    te = () =>
      i(document.body, m.shown) &&
      !i(document.body, m["toast-shown"]) &&
      !i(document.body, m["no-backdrop"]),
    ne = () => h() && i(h(), m.toast);
  function oe(e) {
  ...
  const Se = [
    ...
    qe =
      ((T.text =
        ...
        T.url =
          (e, t) => (
            De(e, t.inputValue), He(e, e, t), je(e, t), (e.type = t.input), e
          )),
  ...
  const Et = (e) => {
      e.isAwaitingPromise()
        ? (Tt(p, e), p.awaitingPromise.set(e, !0))
        : (Tt(at, e), Tt(p, e));
    },
    Tt = (e, t) => {
      ...
      if (n.input) {
        ...
        if (n.inputValidator) {
          ...
          c.then((e) => {
            i.enableButtons(),
              i.enableInput(),
              e ? i.showValidationMessage(e) : ("deny" === r ? It : Vt)(i, a);
          });
        } else
      ...
      t.container.onmousedown = () => {
        t.popup.onmouseup = function (e) {
          (t.popup.onmouseup = void 0),
            (e.target !== t.popup && !t.popup.contains(e.target)) || (Rt = !0);
        };
      };
    },
    Wt = (n, o, i) => {
    ...
    bindClickHandler: function () {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ...
          : "data-swal-template";
      (Xt[e] = this),
        Zt || (document.body.addEventListener("click", $t), (Zt = !0));
    },
  });
  class Qt {
    constructor(e, t) {
  ...
  const Gt = ["swal-title", "swal-html", "swal-footer"],
    en = (e) => {
      ...
      return (
        Array.from(e.querySelectorAll("swal-param")).forEach((e) => {
          ...
          "boolean" == typeof c[t] && (n[t] = "false" !== e),
            "object" == typeof c[t] && (n[t] = JSON.parse(e));
        }),
        n
      );
    },
    ...
    ln = (e) => {
      ...
      e.target === t &&
        ((e = g()),
        t.removeEventListener(Pe, ln),
        (e.style.overflowY = "auto"));
    },
    un = (e, t) => {
      Pe && pe(t)
        ? ((e.style.overflowY = "hidden"), t.addEventListener(Pe, ln))
        : (e.style.overflowY = "auto");
    },
    dn = (e, t, n) => {
      ct(),
  ...
  const hn = (l, u, d) =>
    ...
    fn = (e, t) => {
      var n = (n =
          ...
          ? ((n = n.content),
            sn(n),
            Object.assign(en(n), tn(n), nn(n), on(n), an(n), rn(n, Gt)))
          : {},
